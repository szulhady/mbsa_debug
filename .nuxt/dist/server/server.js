...
/******/ 			var chunk = require("./" + ({"1":"components/admin-building-table","2":"components/admin-user-table","3":"components/bar-chart-horizontal","4":"components/bar-chart-horizontal2","5":"components/bar-chart-vertival","6":"components/button","7":"components/class-button","8":"components/class-list","9":"components/detail-building","10":"components/detail-card","11":"components/detail-cards","12":"components/frame","13":"components/frame2","14":"components/frame3","15":"components/frame4","16":"components/line-graph","17":"components/login-form","18":"components/logo","19":"components/maps","20":"components/maps2","21":"components/mbsa-energy-consumption","22":"components/multiple-line-chart","23":"components/multiple-line-chart2","24":"components/multiple-line-chart3","25":"components/notification","26":"components/register-form2","27":"components/single-line-chart","28":"components/single-line-chart2","29":"components/vuetify-logo","30":"pages/admin","31":"pages/building","32":"pages/details","33":"pages/index","34":"pages/landing","35":"pages/login","36":"pages/main","37":"pages/register"}[chunkId]||chunkId) + ".js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "x", function() { return kebabCase; });
/* unused harmony export isObject */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "y", function() { return keyCodes; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "C", function() { return remapInternalIcon; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "z", function() { return keys; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "B", function() { return padEnd; });
...
/* harmony import */ var _mixins_elevatable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(39);
...
/* harmony import */ var _VCard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(51);
...
/* harmony import */ var _color_transformSRGB__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(18);
// Utilities
...
function parseHex(hex) {
  ...
  if (hex.length === 6) {
    hex = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* padEnd */ "B"])(hex, 8, 'F');
  } else {
    hex = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* padEnd */ "B"])(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* padEnd */ "B"])(hex, 6), 8, 'F');
  }
...
function mergeStyles(target, source) {
  ...
  target = Object(_helpers__WEBPACK_IMPORTED_MODULE_0__[/* wrapInArray */ "H"])(typeof target === 'string' ? parseStyle(target) : target);
  return target.concat(typeof source === 'string' ? parseStyle(source) : source);
}
function mergeClasses(target, source) {
  if (!source) return target;
  if (!target) return source;
  return target ? Object(_helpers__WEBPACK_IMPORTED_MODULE_0__[/* wrapInArray */ "H"])(target).concat(source) : source;
}
...
var bootable = __webpack_require__(42);
...
var VItemGroup = __webpack_require__(140);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/mixins/comparable/index.js
var comparable = __webpack_require__(61);
...
var VListItemAction = __webpack_require__(53);
...
/* harmony default export */ var expand_transition = (function (expandedParentClass = '', x = false) {
  ...
  const offsetProperty = `offset${Object(helpers["G" /* upperFirst */])(sizeProperty)}`;
  return {
    beforeEnter(el) {
...
"use strict";
/* harmony import */ var _VIcon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50);
...
/* harmony import */ var _src_directives_ripple_VRipple_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(117);
...
function keyboardRippleShow(e) {
  if (!keyboardRipple && (e.keyCode === _util_helpers__WEBPACK_IMPORTED_MODULE_1__[/* keyCodes */ "y"].enter || e.keyCode === _util_helpers__WEBPACK_IMPORTED_MODULE_1__[/* keyCodes */ "y"].space)) {
    keyboardRipple = true;
    rippleShow(e);
  }
}
...
/* harmony import */ var _mixins_groupable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(38);
...
/* harmony default export */ __webpack_exports__["a"] = (baseMixins.extend().extend({
  ...
  render(h) {
    ...
    data[this.to ? 'nativeOn' : 'on'] = { ...data[this.to ? 'nativeOn' : 'on'],
      keydown: e => {
        /* istanbul ignore else */
        if (e.keyCode === _util_helpers__WEBPACK_IMPORTED_MODULE_7__[/* keyCodes */ "y"].enter) this.click(e);
        this.$emit('keydown', e);
      }
    };
...
class presets_Presets extends service["a" /* Service */] {
  constructor(parentPreset, parent) {
    ...
    const defaultPreset = Object(helpers["A" /* mergeDeep */])({}, default_preset); // The user provided preset
    ...
    parent.preset = Object(helpers["A" /* mergeDeep */])(Object(helpers["A" /* mergeDeep */])(defaultPreset, globalPreset), preset);
  }
...
var services_goto = __webpack_require__(180);
...
class icons_Icons extends service["a" /* Service */] {
  constructor(preset) {
    ...
    this.values = Object(helpers["A" /* mergeDeep */])(presets[iconfont], values);
  }
...
var transformSRGB = __webpack_require__(18);
...
function genStyles(theme, cssVar = false) {
  ...
  for (let i = 0; i < colors.length; ++i) {
    ...
    const variants = Object(helpers["z" /* keys */])(value);
...
var VOverlay = __webpack_require__(146);
  ...
  methods: {
    ...
    scrollListener(e) {
      if (e.type === 'keydown') {
        ...
        const up = [helpers["y" /* keyCodes */].up, helpers["y" /* keyCodes */].pageup];
        const down = [helpers["y" /* keyCodes */].down, helpers["y" /* keyCodes */].pagedown];
...
/* harmony import */ var _util_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(46);
...
/* harmony default export */ var VProgressLinear_VProgressLinear = (baseMixins.extend({
  ...
  methods: {
    genContent() {
      const slot = Object(helpers["t" /* getSlot */])(this, 'default', {
...
/* @vue/component */
  ...
  methods: {
    getIcon() {
      ...
      return Object(_util_helpers__WEBPACK_IMPORTED_MODULE_5__[/* remapInternalIcon */ "C"])(this, iconName);
    },
    ...
    getSize() {
      ...
      const explicitSize = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_5__[/* keys */ "z"])(sizes).find(key => sizes[key]);
...
"use strict";
/* harmony import */ var _src_components_VCard_VCard_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88);
...
var VBtn = __webpack_require__(115);
...
var VProgressCircular = __webpack_require__(119);
...
var elevatable = __webpack_require__(39);
...
"use strict";
/* harmony import */ var _bootable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
/* harmony import */ var _util_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var _util_mixins__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2);
...
module.exports.__inject__ = function (context) {
  add("0f2b82b2", content, true, context)
};
...
function inserted(el, binding, vnode) {
  ...
  Object(_util_helpers__WEBPACK_IMPORTED_MODULE_0__[/* keys */ "z"])(handlers).forEach(eventName => {
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("3f6f9d7f", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("b3cb884e", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("0340c240", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_ab9648aa_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(69);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_ab9648aa_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_ab9648aa_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_ab9648aa_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_error_vue_vue_type_style_index_0_id_ab9648aa_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "h1[data-v-ab9648aa]{font-size:20px}", ""]);
// Exports
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".v-main__wrap:before{z-index:-5;background:linear-gradient(180deg,rgba(50,70,80,.9),#0d101b)}.v-main__wrap:after,.v-main__wrap:before{content:\"\";position:fixed;top:0;left:0;right:0;height:100%}.v-main__wrap:after{z-index:-10;background-color:#273136;background-image:linear-gradient(180deg,rgba(50,70,80,.9),#0d101b);background-image:url(/cover.jpg);background-repeat:no-repeat;background-position:50%;background-attachment:scroll;transition:background .2s linear;background-size:cover}.section2{min-height:100vh;min-width:100vw;overflow:hidden;background:0 0;position:relative;z-index:1}.section2:before{content:\"\";position:fixed;top:0;left:0;right:0;height:100%;background-color:transparent;background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:4.6875rem;background-repeat:repeat;background-attachment:scroll}.section2{background-color:#273136}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_id_96f6fc6c_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_id_96f6fc6c_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_id_96f6fc6c_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_id_96f6fc6c_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_0_id_96f6fc6c_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_0___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "*[data-v-96f6fc6c]{font-family:\"Montserrat\",sans-serif}.v-application[data-v-96f6fc6c]:before{content:\"\";position:fixed;top:0;left:0;right:0;height:100%;background-color:transparent;background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:4.6875rem;background-repeat:repeat;background-attachment:scroll}.v-application[data-v-96f6fc6c]{background-color:#273136;z-index:1}.v-main__wrap[data-v-96f6fc6c]:before{z-index:-5;background:linear-gradient(180deg,rgba(50,70,80,.9),#0d101b)}.v-main__wrap[data-v-96f6fc6c]:after,.v-main__wrap[data-v-96f6fc6c]:before{content:\"\";position:fixed;top:0;left:0;right:0;height:100%}.v-main__wrap[data-v-96f6fc6c]:after{z-index:-10;background-color:#273136;background-image:linear-gradient(180deg,rgba(50,70,80,.9),#0d101b);background-image:url(/cover.jpg);background-repeat:no-repeat;background-position:50%;background-attachment:scroll;transition:background .2s linear;background-size:cover}.title-main[data-v-96f6fc6c]{font-size:1rem;color:#fff;padding-left:20px}.logout[data-v-96f6fc6c]{position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);z-index:9999;width:300px}.hr[data-v-96f6fc6c]{margin:0 20px;border-top:10px solid #bdc7c7}.logout-btn[data-v-96f6fc6c]{width:100px;margin-right:10px;margin-bottom:10px}.layer[data-v-96f6fc6c]{position:absolute;width:100%;height:100%;background:#000;opacity:.6;z-index:999}.logout-card[data-v-96f6fc6c]{background-color:rgba(0,0,0,.5);-webkit-backdrop-filter:blur(2px);backdrop-filter:blur(2px)}.logout-card2[data-v-96f6fc6c]{background-color:transparent;border:3px solid #40566b}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(75);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_main_vue_vue_type_style_index_1_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".font-shadow{text-shadow:2px 2px #000}.neon3{font-size:var(--font-size);position:relative;cursor:pointer;border:.125em solid var(--clr-neon);padding:.25em 1em;border-radius:.25em;text-shadow:0 0 .2em hsla(0,0%,100%,.46667),0 0 .3em var(--clr-neon);box-shadow:inset 0 0 .5em var(--clr-neon),0 0 .5em var(--clr-neon)}.neon3:before{top:90%;width:100%;height:100%;transform:perspective(1.2em) rotateX(5deg) scaleY(0);filter:blur(.5em);opacity:.6;pointer-events:none}.neon3:after,.neon3:before{content:\"\";position:absolute;left:0;background:var(--clr-neon);transition:opacity .1s linear}.neon3:after{top:0;right:0;bottom:0;box-shadow:0 0 2em var(--clr-neon);z-index:-1;opacity:0}.neon3:hover:after{opacity:1}.neon3:focus,.neon3:hover{color:#fff}.neon3:hover:before{opacity:.8}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const state = () => ({
  ...
  {
    desc: "net floor area",
    image: "NETFLOORAREA.png",
    data: null
  }, {
    desc: "no of occupants",
    image: "1.png",
    data: null
  }, {
...
const mutations = {
  ...
  setActiveUser(state, payload) {
    let user;
    state.status = []; // if(state.auth.user.station[0] == 'ipah1'){
    //   user = 0
  ...
  setLocations(state, payload) {
    ...
    state.locations = payload; // console.log('sana',state.locations)

    state.showData = true;
  },

  setBuildingDetail(state, payload) {
    console.log(payload); // 0 owner
    // 1 floor
    // 2 area
    // 3 occupants
    // 4 cei
    ...
    } else state.buildingDetails[0].data = payload.owner; // if(payload.no_of_floors == null){
...
__webpack_require__.d(components_namespaceObject, "BarChartHorizontal2", function() { return BarChartHorizontal2; });
...
__webpack_require__.d(components_namespaceObject, "ClassButton", function() { return ClassButton; });
__webpack_require__.d(components_namespaceObject, "ClassList", function() { return ClassList; });
...
__webpack_require__.d(components_namespaceObject, "MultipleLineChart2", function() { return MultipleLineChart2; });
__webpack_require__.d(components_namespaceObject, "MultipleLineChart3", function() { return MultipleLineChart3; });
...
__webpack_require__.d(components_namespaceObject, "SingleLineChart2", function() { return SingleLineChart2; });
__webpack_require__.d(components_namespaceObject, "VuetifyLogo", function() { return VuetifyLogo; });
__webpack_require__.d(components_namespaceObject, "AdminBuildingTable", function() { return AdminBuildingTable; });
__webpack_require__.d(components_namespaceObject, "AdminUserTable", function() { return AdminUserTable; });
...
const middleware = {};
middleware['isAdmin'] = __webpack_require__(91);
middleware['isAdmin'] = middleware['isAdmin'].default || middleware['isAdmin'];
middleware['isRegistered'] = __webpack_require__(92);
...
const _4dc8c740 = () => interopDefault(__webpack_require__.e(/* import() | pages/admin */ 30).then(__webpack_require__.bind(null, 400)));

const _0337929a = () => interopDefault(__webpack_require__.e(/* import() | pages/building */ 31).then(__webpack_require__.bind(null, 399)));

const _391380da = () => interopDefault(__webpack_require__.e(/* import() | pages/details */ 32).then(__webpack_require__.bind(null, 401)));

const _7a3f94e8 = () => interopDefault(__webpack_require__.e(/* import() | pages/landing */ 34).then(__webpack_require__.bind(null, 402)));

const _7153eb7a = () => interopDefault(__webpack_require__.e(/* import() | pages/login */ 35).then(__webpack_require__.bind(null, 403)));

const _0cb9fdd7 = () => interopDefault(__webpack_require__.e(/* import() | pages/main */ 36).then(__webpack_require__.t.bind(null, 398, 7)));

const _59ae79bc = () => interopDefault(__webpack_require__.e(/* import() | pages/register */ 37).then(__webpack_require__.bind(null, 404)));

const _b0a76f3a = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 33).then(__webpack_require__.bind(null, 405)));
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/error.vue?vue&type=template&id=ab9648aa&scoped=true&
var errorvue_type_template_id_ab9648aa_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"dark":""}},[(_vm.error.statusCode === 404)?_c('h1',[_vm._v("\n    "+_vm._s(_vm.pageNotFound)+"\n  ")]):_c('h1',[_vm._v("\n    "+_vm._s(_vm.otherError)+"\n  ")]),_vm._v(" "),_c('NuxtLink',{attrs:{"to":"/"}},[_vm._v(" Home page ")])],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./layouts/error.vue?vue&type=template&id=ab9648aa&scoped=true&
...
var error_component = Object(componentNormalizer["a" /* default */])(
  ...
  errorvue_type_template_id_ab9648aa_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "ab9648aa",
...
var layouts_global = __webpack_require__(99);
...
/* harmony default export */ var VToolbar_VToolbar = (VSheet["a" /* default */].extend({
  ...
  methods: {
    ...
    genExtension() {
      ...
      }, Object(helpers["t" /* getSlot */])(this, 'extension'));
    }
...
var VGrid = __webpack_require__(83);
...
var VFooter = __webpack_require__(128);
...
var VIcon_VIcon = __webpack_require__(50);
...
var VMain = __webpack_require__(142);
...
var VNavigationDrawer = __webpack_require__(144);
...
var overlayable = __webpack_require__(31);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/directives/click-outside/index.js
var click_outside = __webpack_require__(35);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/directives/resize/index.js
var resize = __webpack_require__(57);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/directives/touch/index.js
var touch = __webpack_require__(72);
...
var VSpacer = __webpack_require__(188);
...
const VToolbarTitle = Object(helpers["j" /* createSimpleFunctional */])('v-toolbar__title');
const VToolbarItems = Object(helpers["j" /* createSimpleFunctional */])('v-toolbar__items');
...
installComponents_default()(default_component, {VApp: VApp_VApp,VAppBar: VAppBar_VAppBar,VAppBarNavIcon: VAppBarNavIcon,VBtn: VBtn["a" /* default */],VCardSubtitle: VCard["b" /* VCardSubtitle */],VCardTitle: VCard["d" /* VCardTitle */],VContainer: VContainer,VFooter: VFooter_VFooter,VIcon: VIcon_VIcon["a" /* default */],VImg: VImg_VImg,VList: VList["a" /* default */],VListItem: VListItem["a" /* default */],VListItemAction: VListItemAction["a" /* default */],VListItemContent: components_VList["a" /* VListItemContent */],VListItemTitle: components_VList["b" /* VListItemTitle */],VMain: VMain_VMain,VNavigationDrawer: VNavigationDrawer_VNavigationDrawer,VSpacer: VSpacer["a" /* default */],VToolbarTitle: VToolbarTitle})

// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/login.vue?vue&type=template&id=b7d50624&
var loginvue_type_template_id_b7d50624_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',[_c('v-main',{staticClass:"section2"},[_c('nuxt')],1)],1)}
var loginvue_type_template_id_b7d50624_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/login.vue?vue&type=template&id=b7d50624&
...
var login_component = Object(componentNormalizer["a" /* default */])(
  ...
  loginvue_type_template_id_b7d50624_render,
  loginvue_type_template_id_b7d50624_staticRenderFns,
  false,
  login_injectStyles,
  null,
  "31a313d9"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/main.vue?vue&type=template&id=96f6fc6c&scoped=true&
var mainvue_type_template_id_96f6fc6c_scoped_true_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-app',{attrs:{"dark":""}},[_c('v-app-bar',{attrs:{"clipped-left":_vm.clipped,"fixed":"","app":"","height":"46px","color":"rgba(64, 86, 107, 1)"}},[_c('img',{attrs:{"src":"selangor.svg","alt":"nex-plex-logo","width":"30px"}}),_vm._v(" "),_c('v-toolbar-title',{staticClass:"title-main font-shadow",domProps:{"textContent":_vm._s(_vm.title)}}),_vm._v(" "),_c('v-spacer'),_vm._v(" "),(_vm.loggedInUser)?_c('div',{staticClass:"user-name-container"},[_c('h4',{staticClass:"user-name-title font-shadow",staticStyle:{"color":"white"}},[_vm._v("\n        "+_vm._s(_vm.loggedInUser.username)+"\n      ")])]):_vm._e(),_vm._v(" "),_c('div',{staticClass:"logout-container"},[_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){$event.stopPropagation();_vm.rightDrawer = !_vm.rightDrawer}}},[(_vm.loggedInUser)?_c('v-icon',{attrs:{"color":"success"}},[_vm._v("mdi-logout")]):_vm._e()],1)],1)],1),_vm._v(" "),_c('v-main',[_c('v-scroll-y-transition',[(_vm.rightDrawer)?_c('div',{staticClass:"layer",attrs:{"id":"layer"}}):_vm._e()]),_vm._v(" "),_c('v-scroll-y-transition',[_c('v-dialog',{staticClass:"logout",attrs:{"max-width":"290"},model:{value:(_vm.rightDrawer),callback:function ($$v) {_vm.rightDrawer=$$v},expression:"rightDrawer"}},[_c('v-card',{staticClass:"logout-card"},[_c('v-card',{staticClass:"logout-card2"},[_c('v-card-title',{staticClass:"text-h5",staticStyle:{"color":"#eee"}},[_vm._v("\n              Logout?\n            ")]),_vm._v(" "),_c('v-card-text',{staticStyle:{"color":"#eee"}},[_vm._v("\n              Are you sure you want to logout?\n            ")]),_vm._v(" "),_c('v-card-actions',[_c('v-spacer'),_vm._v(" "),_c('v-btn',{attrs:{"color":"red darken-1","text":""},on:{"click":_vm.logout}},[_vm._v(" Yes ")]),_vm._v(" "),_c('v-btn',{attrs:{"color":"green darken-1","text":""},on:{"click":_vm.cancel}},[_vm._v(" No ")])],1)],1)],1)],1)],1),_vm._v(" "),_c('v-layout',[_c('nuxt')],1)],1)],1)}
var mainvue_type_template_id_96f6fc6c_scoped_true_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/main.vue?vue&type=template&id=96f6fc6c&scoped=true&
...
var VCard_VCard = __webpack_require__(51);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VDialog/VDialog.js
var VDialog = __webpack_require__(189);
...
if (style0.__inject__) style0.__inject__(context)
var style1 = __webpack_require__(152)
...
var main_component = Object(componentNormalizer["a" /* default */])(
  ...
  mainvue_type_template_id_96f6fc6c_scoped_true_render,
  mainvue_type_template_id_96f6fc6c_scoped_true_staticRenderFns,
  false,
  main_injectStyles,
  "96f6fc6c",
  "28de8b0e"
...
installComponents_default()(main_component, {VApp: VApp_VApp,VAppBar: VAppBar_VAppBar,VBtn: VBtn["a" /* default */],VCard: VCard_VCard["a" /* default */],VCardActions: VCard["a" /* VCardActions */],VCardText: VCard["c" /* VCardText */],VCardTitle: VCard["d" /* VCardTitle */],VDialog: VDialog["a" /* default */],VIcon: VIcon_VIcon["a" /* default */],VLayout: VLayout,VMain: VMain_VMain,VScrollYTransition: transitions["d" /* VScrollYTransition */],VSpacer: VSpacer["a" /* default */],VToolbarTitle: VToolbarTitle})
...
(function updateModules() {
  store_store = normalizeRoot(__webpack_require__(156), 'store/index.js'); // If store is an exported method = classic mode (deprecated)
...
const BarChartHorizontal = () => __webpack_require__.e(/* import() | components/bar-chart-horizontal */ 3).then(__webpack_require__.bind(null, 334)).then(c => wrapFunctional(c.default || c));
const BarChartHorizontal2 = () => __webpack_require__.e(/* import() | components/bar-chart-horizontal2 */ 4).then(__webpack_require__.bind(null, 356)).then(c => wrapFunctional(c.default || c));
const BarChartVertival = () => __webpack_require__.e(/* import() | components/bar-chart-vertival */ 5).then(__webpack_require__.bind(null, 361)).then(c => wrapFunctional(c.default || c));
const Button = () => __webpack_require__.e(/* import() | components/button */ 6).then(__webpack_require__.bind(null, 337)).then(c => wrapFunctional(c.default || c));
const ClassButton = () => __webpack_require__.e(/* import() | components/class-button */ 7).then(__webpack_require__.bind(null, 296)).then(c => wrapFunctional(c.default || c));
const ClassList = () => __webpack_require__.e(/* import() | components/class-list */ 8).then(__webpack_require__.bind(null, 332)).then(c => wrapFunctional(c.default || c));
const DetailBuilding = () => __webpack_require__.e(/* import() | components/detail-building */ 9).then(__webpack_require__.bind(null, 336)).then(c => wrapFunctional(c.default || c));
const DetailCard = () => __webpack_require__.e(/* import() | components/detail-card */ 10).then(__webpack_require__.bind(null, 213)).then(c => wrapFunctional(c.default || c));
const DetailCards = () => __webpack_require__.e(/* import() | components/detail-cards */ 11).then(__webpack_require__.bind(null, 297)).then(c => wrapFunctional(c.default || c));
const Frame = () => __webpack_require__.e(/* import() | components/frame */ 12).then(__webpack_require__.bind(null, 406)).then(c => wrapFunctional(c.default || c));
const Frame2 = () => __webpack_require__.e(/* import() | components/frame2 */ 13).then(__webpack_require__.bind(null, 360)).then(c => wrapFunctional(c.default || c));
const Frame3 = () => __webpack_require__.e(/* import() | components/frame3 */ 14).then(__webpack_require__.bind(null, 407)).then(c => wrapFunctional(c.default || c));
const Frame4 = () => __webpack_require__.e(/* import() | components/frame4 */ 15).then(__webpack_require__.bind(null, 408)).then(c => wrapFunctional(c.default || c));
const LineGraph = () => __webpack_require__.e(/* import() | components/line-graph */ 16).then(__webpack_require__.bind(null, 338)).then(c => wrapFunctional(c.default || c));
const Logo = () => __webpack_require__.e(/* import() | components/logo */ 18).then(__webpack_require__.bind(null, 412)).then(c => wrapFunctional(c.default || c));
const Maps = () => __webpack_require__.e(/* import() | components/maps */ 19).then(__webpack_require__.bind(null, 335)).then(c => wrapFunctional(c.default || c));
const Maps2 = () => __webpack_require__.e(/* import() | components/maps2 */ 20).then(__webpack_require__.bind(null, 409)).then(c => wrapFunctional(c.default || c));
const MbsaEnergyConsumption = () => __webpack_require__.e(/* import() | components/mbsa-energy-consumption */ 21).then(__webpack_require__.bind(null, 410)).then(c => wrapFunctional(c.default || c));
const MultipleLineChart = () => __webpack_require__.e(/* import() | components/multiple-line-chart */ 22).then(__webpack_require__.bind(null, 358)).then(c => wrapFunctional(c.default || c));
const MultipleLineChart2 = () => __webpack_require__.e(/* import() | components/multiple-line-chart2 */ 23).then(__webpack_require__.bind(null, 411)).then(c => wrapFunctional(c.default || c));
const MultipleLineChart3 = () => __webpack_require__.e(/* import() | components/multiple-line-chart3 */ 24).then(__webpack_require__.bind(null, 357)).then(c => wrapFunctional(c.default || c));
const Notification = () => __webpack_require__.e(/* import() | components/notification */ 25).then(__webpack_require__.bind(null, 204)).then(c => wrapFunctional(c.default || c));
const SingleLineChart = () => __webpack_require__.e(/* import() | components/single-line-chart */ 27).then(__webpack_require__.bind(null, 295)).then(c => wrapFunctional(c.default || c));
const SingleLineChart2 = () => __webpack_require__.e(/* import() | components/single-line-chart2 */ 28).then(__webpack_require__.bind(null, 355)).then(c => wrapFunctional(c.default || c));
const VuetifyLogo = () => __webpack_require__.e(/* import() | components/vuetify-logo */ 29).then(__webpack_require__.bind(null, 413)).then(c => wrapFunctional(c.default || c));
const AdminBuildingTable = () => __webpack_require__.e(/* import() | components/admin-building-table */ 1).then(__webpack_require__.bind(null, 353)).then(c => wrapFunctional(c.default || c));
const AdminUserTable = () => __webpack_require__.e(/* import() | components/admin-user-table */ 2).then(__webpack_require__.bind(null, 354)).then(c => wrapFunctional(c.default || c));
const LoginForm = () => __webpack_require__.e(/* import() | components/login-form */ 17).then(__webpack_require__.bind(null, 333)).then(c => wrapFunctional(c.default || c));
const RegisterForm2 = () => __webpack_require__.e(/* import() | components/register-form2 */ 26).then(__webpack_require__.bind(null, 359)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
var external_google_maps_api_loader_ = __webpack_require__(79);
...
const MarkerClusterer = __webpack_require__(157);
...
var external_moment_timezone_ = __webpack_require__(160);
...
var external_echarts_ = __webpack_require__(81);
...
var external_cookie_ = __webpack_require__(56);
...
"use strict";
/* harmony import */ var _src_components_VDialog_VDialog_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(154);
/* harmony import */ var _src_components_VDialog_VDialog_sass__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_components_VDialog_VDialog_sass__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _VThemeProvider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(162);
/* harmony import */ var _mixins_activatable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(58);
/* harmony import */ var _mixins_dependent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34);
/* harmony import */ var _mixins_detachable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(62);
/* harmony import */ var _mixins_overlayable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(31);
...
/* harmony import */ var _directives_click_outside__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(35);
/* harmony import */ var _util_mixins__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2);
