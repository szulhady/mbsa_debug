...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("30cabbdf", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClassList_vue_vue_type_style_index_0_id_206d5458_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(280);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClassList_vue_vue_type_style_index_0_id_206d5458_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClassList_vue_vue_type_style_index_0_id_206d5458_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClassList_vue_vue_type_style_index_0_id_206d5458_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ClassList_vue_vue_type_style_index_0_id_206d5458_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".col[data-v-206d5458]{padding-left:2px;padding-right:2px}.v-card__subtitle[data-v-206d5458]{font-size:.9em;padding:0 0 0 40px;color:#f0f8ff}[data-v-206d5458]::-webkit-scrollbar{width:10px}[data-v-206d5458]::-webkit-scrollbar-track{box-shadow:inset 0 0 10px 10px #fff;border:3px solid transparent}[data-v-206d5458]::-webkit-scrollbar-thumb{box-shadow:inset 0 0 10px 10px #025a73;border:3px solid transparent}.left2[data-v-206d5458]{width:40%;display:flex;flex-direction:column}.right2[data-v-206d5458]{width:100%;overflow-x:hidden}.active[data-v-206d5458]{font-size:var(--font-size);position:relative;cursor:pointer;border:.125em solid red!important;padding:.25em 1em;border-radius:.25em;text-shadow:0 0 .2em hsla(0,0%,100%,.46667),0 0 .3em red;box-shadow:inset 0 0 .5em red,0 0 .5em red}.active[data-v-206d5458]:before{top:90%;width:100%;height:100%;transform:perspective(1.2em) rotateX(5deg) scaleY(0);filter:blur(.5em);opacity:.6;pointer-events:none}.active[data-v-206d5458]:after,.active[data-v-206d5458]:before{content:\"\";position:absolute;left:0;background:red;transition:opacity .1s linear}.active[data-v-206d5458]:after{top:0;right:0;bottom:0;box-shadow:0 0 2em red;z-index:-1;opacity:0}.active[data-v-206d5458]:hover:after{opacity:1}.active[data-v-206d5458]:focus,.active[data-v-206d5458]:hover{color:#fff}.active[data-v-206d5458]:hover:before{opacity:.8}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/ClassList.vue?vue&type=template&id=206d5458&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"level"},[_vm._ssrNode("<div style=\"display: flex; max-width: 30vw; height: 30vh\" data-v-206d5458>","</div>",[_vm._ssrNode("<div class=\"right2\" data-v-206d5458>","</div>",[(_vm.categories)?_vm._ssrNode("<div data-v-206d5458>","</div>",[_c('v-row',{staticStyle:{"justify-content":"space-evenly"}},_vm._l((_vm.categories),function(category,index){return _c('v-col',{key:index,staticStyle:{"flex-grow":"0"}},[_c('v-btn',{staticClass:"neon3",class:{ active: index === _vm.activeCategory },staticStyle:{"width":"9vw","height":"7vh","font-size":"0.8em"},on:{"click":function($event){return _vm.selectCategory(index)}}},[_vm._v(_vm._s(category.category))])],1)}),1)],1):_vm._e()])]),_vm._ssrNode(" <div style=\"border-bottom: 4px dashed white; margin: 1vh 2vw\" data-v-206d5458></div> "),_vm._ssrNode("<div style=\"display: flex; max-width: 30vw; height: 40vh\" data-v-206d5458>","</div>",[_vm._ssrNode("<div class=\"right2\" data-v-206d5458>","</div>",[(_vm.categories)?_vm._ssrNode("<div data-v-206d5458>","</div>",[_c('v-card-title',[_vm._v("Select building")]),_vm._ssrNode(" "),_c('v-row',{staticStyle:{"justify-content":"space-evenly"}},_vm._l((_vm.categories[_vm.activeCategory].locations),function(location,index){return _c('v-col',{key:index,staticStyle:{"flex-grow":"0"}},[_c('v-btn',{staticClass:"neon3",class:{ active: index === _vm.activeBuilding },staticStyle:{"width":"12vw","height":"7vh","font-size":"0.8em"},on:{"click":function($event){return _vm.selectBuilding(index)}}},[_vm._v(_vm._s(location.name))])],1)}),1)],2):_vm._e()])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/ClassList.vue?vue&type=template&id=206d5458&scoped=true&
...
/* harmony default export */ var ClassListvue_type_script_lang_js_ = ({
  ...
  methods: { ...Object(external_vuex_["mapMutations"])({
    ...
    getCategory: function () {
      this.$axios.$get("https://debug2.qwazx.one:5000/api/data/category", {// params: {
        //   id: id,
        // },
      }).then(response => {
    ...
    getBuildingData: function (id) {
      this.$axios.$get("https://debug2.qwazx.one:5000/api/data/building", {
        params: {
          id: id
        }
      }).then(response => {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/details.vue?vue&type=template&id=6a235616&
...
// CONCATENATED MODULE: ./pages/details.vue?vue&type=template&id=6a235616&
...
/* harmony default export */ var detailsvue_type_script_lang_js_ = ({
  ...
  methods: {
    getEnergy: function (id) {
      this.$axios.$get(`https://debug2.qwazx.one:5000/api/data/building/energy`, {
        params: {
          building_id: id
        }
      }).then(response => {
    ...
    getBei: function (id) {
      this.$axios.$get(`https://debug2.qwazx.one:5000/api/data/building/bei`, {
        params: {
          building_id: id
        }
      }).then(response => {
