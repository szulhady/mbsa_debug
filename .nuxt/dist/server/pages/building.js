...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("4d24c78d", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_building_vue_vue_type_style_index_1_id_3dbb588a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(342);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_building_vue_vue_type_style_index_1_id_3dbb588a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_building_vue_vue_type_style_index_1_id_3dbb588a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_building_vue_vue_type_style_index_1_id_3dbb588a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_building_vue_vue_type_style_index_1_id_3dbb588a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".left[data-v-3dbb588a]{width:22vw;height:calc(100vh - 90px)!important;padding-left:1vw;padding-right:1vw;margin-top:3vh;position:relative;flex-direction:column}.left[data-v-3dbb588a],.right[data-v-3dbb588a]{display:flex;justify-content:center;align-items:center}.right[data-v-3dbb588a]{width:78vw;height:calc(100vh - 50px)!important;padding:1vw}.card[data-v-3dbb588a]:hover{cursor:pointer}.button-container[data-v-3dbb588a]{display:flex;justify-content:space-around;align-items:center;width:100%}.map-con[data-v-3dbb588a]{width:100%;height:100%}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./pages/building.vue?vue&type=template&id=3dbb588a&scoped=true&
...
/* harmony default export */ var buildingvue_type_script_lang_js_ = ({
  ...
  methods: { ...Object(external_vuex_["mapMutations"])({
    ...
    getYear: function (id) {
      this.$axios.$get(`https://soap.txio.live/api/data/building/year`, {
        params: {
          building_id: id
        }
      }).then(response => {
    ...
    getDetails: function (id) {
      this.$axios.$get(`https://soap.txio.live/api/data/building/details`, {
        params: {
          building_id: id
        }
      }).then(response => {
    ...
    updateDetail: function () {
      this.$axios.$post(`https://soap.txio.live/api/data/building/details`, null, {
        params: {
    ...
    updateOwner: function () {
      this.$axios.$put(`https://soap.txio.live/api/data/building/owner`, {
        params: {
    ...
    getDataYearly: function (id, year) {
      this.$axios.$get(`https://soap.txio.live/api/data/yearly/building`, {
        params: {
          building_id: id,
          year: year
        }
    ...
    updateData: function () {
      this.$axios.$post(`https://soap.txio.live/api/data/building/data`, null, {
        params: {
    ...
    getEnergy: function (id) {
      this.$axios.$get(`https://soap.txio.live/api/data/building/energy`, {
        params: {
          building_id: id
        }
      }).then(response => {
    ...
    getEnergyMonth: function (id, year) {
      this.$axios.$get(`https://soap.txio.live/api/data/building/energy/month`, {
        params: {
          building_id: id,
          year
        }
    ...
    getEnergyAll: function (id, category, year) {
      this.$axios.$get(`https://soap.txio.live/api/data/building/energy/all`, {
        params: {
          building_id: id,
          category: category,
          year: year
    ...
    getBei: function (id) {
      this.$axios.$get(`https://soap.txio.live/api/data/building/bei`, {
        params: {
          building_id: id
        }
      }).then(response => {
