...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"https://soap.txio.live/api/auth/login","method":"post","propertyName":"token"},"logout":false,"user":{"url":"https://soap.txio.live/api/auth/me","method":"GET","propertyName":false}},"scheme":"local","token":{"maxAge":10000,"type":"Bearer"},"tokenType":"Bearer","localStorage":false,"_name":"local"}))
